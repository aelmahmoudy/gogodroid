/*
-----------------------------------------------------------------------------
$Id: md5c.c,v 1.1 2009/11/20 16:53:38 jasminko Exp $
-----------------------------------------------------------------------------
...
char *md5(char *string, size_t len) {
   MD5_CTX context;
   ...
   MD5Init(&context);
   MD5Update (&context, (const unsigned char *)string, (int)len);
...
void
md5digest(char *string, size_t len, char *digest)
{
	MD5_CTX context;
