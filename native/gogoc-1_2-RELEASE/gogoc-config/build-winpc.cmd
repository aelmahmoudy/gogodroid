@ECHO OFF
REM *************************************************************************
REM * $Id: build-winpc.cmd,v 1.1 2009/11/20 16:30:23 jasminko Exp $
REM *
...
REM *
REM * Usage:
REM *   build-gogoc [/Release /HACCESS-Release /Debug /HACCESS-Debug] [/Win32 /x64]
REM *
REM *************************************************************************
...
ECHO.
DEVENV winbuild\winpc\gogoc-config.sln /%COMMAND% "%CONFIGURATION%|%PLATFORM%"
