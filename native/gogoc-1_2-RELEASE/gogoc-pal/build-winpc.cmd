@ECHO OFF
REM *************************************************************************
REM * $Id: build-winpc.cmd,v 1.1 2009/11/20 16:38:46 jasminko Exp $
REM *
REM * Batch file used to build the gogoCLIENT PAL.
REM *
REM * Prerequisites:
...
ECHO Launching build of gogoc-pal solution...
ECHO Configuration: COMMAND=%COMMAND% PLATFORM=%PLATFORM% CONFIGURATION=%CONFIGURATION%
ECHO.
DEVENV platform\winpc\gogoc-pal.sln /%COMMAND% "%CONFIGURATION%|%PLATFORM%"
...
:build_ok
ECHO.
ECHO Build of gogoc-pal solution completed successfully.
GOTO the_end

:build_error
ECHO.
ECHO Build of gogoc-pal solution FAILED!
